...
export class Backend implements backendInterface {
    ...
    async createOrUpdateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: bigint): Promise<ProductListing> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateProduct(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrUpdateProfile(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<EntrepreneurProfile> {
        if (this.processError) {
            try {
    ...
    async createProductInquiry(arg0: bigint, arg1: bigint, arg2: string, arg3: string, arg4: string): Promise<ProductInquiry> {
        if (this.processError) {
            try {
                const result = await this.actor.createProductInquiry(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInquiriesByEntrepreneur(arg0: bigint): Promise<Array<ProductInquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInquiriesByEntrepreneur(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProduct(arg0: bigint): Promise<ProductListing> {
        if (this.processError) {
            try {
    ...
    async getProductsByCategory(arg0: bigint): Promise<Array<ProductListing>> {
        if (this.processError) {
            try {
    ...
    async getProductsByEntrepreneur(arg0: bigint): Promise<Array<ProductListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByEntrepreneur(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProfile(arg0: bigint): Promise<EntrepreneurProfile> {
        if (this.processError) {
            try {
    ...
    async getProfilesByCategory(arg0: bigint): Promise<Array<EntrepreneurProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProfilesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeMarketplace(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeMarketplace();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
